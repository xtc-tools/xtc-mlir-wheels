...
CIBW_BEFORE_ALL="./install-build-tools.sh && env BUILD_LLVM_MLIR_BINDINGS=0 BUILD_LLVM_TOOLS=1 MACOSX_DEPLOYMENT_TARGET=15.0 BUILD_LLVM_COMPONENTS=$BUILD_LLVM_COMPONENTS ./build-mlir-bindings.sh"
...
ENV_VARS=(
    ...
    "CIBW_ENVIRONMENT_PASS_${CIBW_PLATFORM^^}"="$CIBW_ENVIRONMENT_PASS"
