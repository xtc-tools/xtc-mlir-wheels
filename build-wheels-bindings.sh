...
env \
    ...
    CIBW_BEFORE_BUILD='rm -rf python_bindings/mlir python_bindings/dist python_bindings/build python_bindings/*egg-info && env BUILD_LLVM_MLIR_BINDINGS=1 BUILD_LLVM_TOOLS=0 BUILD_LLVM_CCACHE=1 ./build-mlir-bindings.sh && mv install-bindings/mlir python_bindings/' \
